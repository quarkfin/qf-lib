...
This file will guide you through the installation process and will help you configure the library for your personal use.
To find the introduction for the QF-Lib project users together with a short description of the library components, 
please check the [modules.md](modules.md) file.
...
dependencies installed (later on you'll need to activate the virtual environment; 
