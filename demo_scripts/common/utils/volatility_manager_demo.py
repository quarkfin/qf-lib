...
series = data_provider.get_price(QuandlTicker('AAPL', 'WIKI'), PriceField.Close,
                                 start_date=start_date, end_date=end_date)

min_lev = 0.2
max_lev = 2
vol_manager = VolatilityManager(series)
managed_series, weights_series = vol_manager.get_managed_series(vol_level=0.2, window_size=20, lag=1,
...
legend.add_entry(series_element, 'Origninal')
