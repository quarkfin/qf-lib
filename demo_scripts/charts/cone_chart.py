...
def main():
    ...
    timeseries = data_provider.get_price(DummyTicker('AAA'), PriceField.Close, start_date, end_date)

    cone_chart = ConeChart(data=timeseries, nr_of_data_points=200, is_end_date=live_start_date)
    cone_chart.plot()
