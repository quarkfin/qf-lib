...
class HeadingElement(Element):
    """
    This represents an ordinary heading, usually used to start a new section in a document.
    """
    def __init__(self, level: int, text: str, grid_proportion=GridProportion.Eight):
        """
        Constructs a new heading element.

        Parameters
        ----------
        level - The level of this heading, must be in range 1..6.
