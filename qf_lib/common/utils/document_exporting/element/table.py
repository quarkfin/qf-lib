...
class Table(Element):
    class Cell(object):
        def __init__(self, value: any, format_string="{}", css_class="", escape_html=True):
            """
    ...
    class ColumnCell(Cell):
        def __init__(self, value: any, format_string="{}", css_class="", column_css_class=""):
            """
    ...
    def __init__(self, column_names=None, css_class="table", title="", grid_proportion=GridProportion.Eight):
        """
        Constructs a new Table element.

        Parameters
        ----------
        column_names: list of strings or ColumnCells
    ...
    def add_row(self, values: List[Any], css_class="") -> None:
        """
    ...
    def insert_column(self, header: Union[str, ColumnCell], cells: List[Any], location: int, css_class="") -> None:
        """
    ...
    def create_diff_column(self, col_index1: int, col_index2: int) -> None:
        """
