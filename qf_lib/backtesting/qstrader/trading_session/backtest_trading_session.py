...
from qf_lib.backtesting.qstrader.position_sizer.naive import NaivePositionSizer
from qf_lib.backtesting.qstrader.risk_manager.example import NaiveRiskManager
...
class BacktestTradingSession(object):
    ...
    def __init__(self, backtest_name: str, settings: Settings, data_provider: GeneralPriceProvider,
        ...
        order_factory = OrderFactory(portfolio, data_handler)
    ...
    def _create_event_manager(timer, notifiers: Notifiers):
        ...
        events_manager.register_notifiers([
            ...
            notifiers.scheduler,
            notifiers.price_event_notifier,
            notifiers.bar_event_notifier,
            notifiers.tick_event_notifier
        ])
