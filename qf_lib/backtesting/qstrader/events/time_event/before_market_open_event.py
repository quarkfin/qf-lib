...
from qf_lib.backtesting.qstrader.events.time_event.regular_date_time_rule import RegularDateTimeRule
from qf_lib.backtesting.qstrader.events.time_event.regular_time_event import RegularTimeEvent
from qf_lib.common.utils.dateutils.relative_delta import RelativeDelta


class BeforeMarketOpenEvent(RegularTimeEvent):
    """
    Rule which is triggered every day when the market opens (8:00 AM for NASDAQ and NYSE).

    The listeners for this event should implement the on_before_market_open() method.
    """

    _trigger_time = {"hour": 8, "minute": 0, "second": 0, "microsecond": 0}
