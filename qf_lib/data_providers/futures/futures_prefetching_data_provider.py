...
class FuturesPrefetchingDataProvider(FuturesPresetDataProvider):
    """
    Optimises running of the DataProvider by pre-fetching all the futures related data at startup and then using the
    cached data instead of sending over-the-network requests every time the data is requested. If not all data requested
    ...
    def __init__(self, data_provider: DataProvider,
        ...
        are being downloaded and stored using the FuturesPresetDataProvider.  In case of the FutureTickers, the future
        ...
        all_future_tickers_dict = data_provider.get_futures_chain_tickers(future_tickers, end_date)
