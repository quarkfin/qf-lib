...
### backtesting
The module contains the code of a Backtester. The whole uses a event-driven architecture. The module that controls the 
events' flow is `EventManager`. Each component may subscribe to certain types of events using that module. `EventManager` 
