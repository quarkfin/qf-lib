...
class TestSeries(unittest.TestCase):
    ...
    def test_valid_ticker_1(self):
        future_ticker = CustomFutureTicker("CustomTicker", "CT{} Custom", self.timer, None,  1, 5, 500)
        ...
        self.assertEqual(future_ticker.valid_ticker(), CustomTicker("B"))

        self.timer.set_current_time(str_to_date('2017-12-10'))
        self.assertEqual(future_ticker.valid_ticker(), CustomTicker("B"))

        self.timer.set_current_time(str_to_date('2017-12-11'))
        self.assertEqual(future_ticker.valid_ticker(), CustomTicker("C"))

    def test_valid_ticker_2(self):
        # Test the 2nd contract instead of front one

        future_ticker = CustomFutureTicker("CustomTicker", "CT{} Custom", self.timer, None,  2, 5, 500)
        ...
        self.timer.set_current_time(str_to_date('2017-12-11'))
        self.assertEqual(future_ticker.valid_ticker(), CustomTicker("D"))

    def test_valid_ticker_3(self):
        future_ticker = CustomFutureTicker("CustomTicker", "CT{} Custom", self.timer, None,  1, 45, 500)
    ...
    def test_valid_ticker_4(self):
        future_ticker = CustomFutureTicker("CustomTicker", "CT{} Custom", self.timer, None,  2, 45, 500)

        self.timer.set_current_time(str_to_date('2017-12-05'))
        # '2017-12-05' + 45 days = '2018-01-19' - the front contract will be equal to CustomTicker:D
        self.assertEqual(future_ticker.valid_ticker(), CustomTicker("E"))
