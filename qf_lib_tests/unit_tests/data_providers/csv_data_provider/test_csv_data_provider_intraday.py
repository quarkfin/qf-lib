...
class TestCSVDataProviderIntraday(TestCase):
    ...
    def test_get_history_single_ticker_many_fields_single_date(self):
        ...
        df = self.data_provider.get_history(self.ticker, self.fields, date, date + RelativeDelta(minutes=1),
                                            Frequency.MIN_1)
    ...
    def test_get_price_single_ticker_single_field_single_date(self):
        ...
        prices = self.data_provider.get_price(self.ticker, PriceField.Close, date, date + RelativeDelta(minutes=1),
                                              Frequency.MIN_1)
    ...
    def test_get_history_single_ticker_single_field_single_date(self):
        ...
        df = self.data_provider.get_history(self.ticker, 'Close', date, date + RelativeDelta(minutes=1),
                                            Frequency.MIN_1)
    ...
    def test_get_history_many_tickers_many_fields_single_date(self):
        date = datetime(2020, 12, 30, 1, 5)
        df = self.data_provider.get_history(self.tickers, self.fields, date, date + RelativeDelta(minutes=1),
                                            Frequency.MIN_1)
    ...
    def test_get_history_many_tickers_single_field_single_date(self):
        date = datetime(2020, 12, 30, 1, 5)
        df = self.data_provider.get_history(self.tickers, 'Close', date, date + RelativeDelta(minutes=1),
                                            Frequency.MIN_1)
