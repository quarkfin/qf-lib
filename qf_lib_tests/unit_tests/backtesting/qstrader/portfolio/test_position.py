...
class TestPosition(unittest.TestCase):
    ...
    def test_creating_empty_position(self):
        ...
        self.assertEqual(position.average_cost_per_share(), 0.0)
    ...
    def test_initial_fill_position(self):
        position = Position(self.ticker)
        position.transact_fill_event(FillEvent(self.time, self.ticker, 50, 100, 5))
        ...
        self.assertEqual(position.average_cost_per_share(), (50*100+5)/50)
        self.assertEqual(position.unrealised_pnl(), 50*110 - (50*100+5))

    def test_without_commission_position(self):
        position = Position(self.ticker)

        position.transact_fill_event(FillEvent(self.time, self.ticker, 50, 100, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, 30, 120, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -20, 175, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -30, 160, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, 10, 150, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, 10, 170, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -20, 150, 0))
        position.update_price(110, 120)
        ...
        self.assertEqual(position.average_cost_per_share(), 118.0)
    ...
    def test_position(self):
        ...
        position.transact_fill_event(FillEvent(self.time, self.ticker, 50, 100, 5))
        position.transact_fill_event(FillEvent(self.time, self.ticker, 30, 120, 3))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -20, 175, 2))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -30, 160, 1))
        position.transact_fill_event(FillEvent(self.time, self.ticker, 10, 150, 7))
        position.transact_fill_event(FillEvent(self.time, self.ticker, 10, 170, 4))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -20, 150, 5))
        position.update_price(110, 120)
        ...
        self.assertEqual(position.average_cost_per_share(),  118.19)
    ...
    def test_position_close(self):
        ...
        position.transact_fill_event(FillEvent(self.time, self.ticker, 20, 100, 0))
        self.assertEqual(position.is_closed, False)
        position.transact_fill_event(FillEvent(self.time, self.ticker, -10, 120, 20))
        self.assertEqual(position.is_closed, False)
        position.transact_fill_event(FillEvent(self.time, self.ticker, -10, 110, 20))
    ...
    def test_position_stats_on_close(self):
        ...
        position.transact_fill_event(FillEvent(self.time, self.ticker, 20, 100, 0))
        position.update_price(110, 120)
        position.transact_fill_event(FillEvent(self.time, self.ticker, -20, 120, 0))
        ...
        self.assertEqual(position.average_cost_per_share(),  100)
    ...
    def test_position_direction(self):
        ...
        position.transact_fill_event(FillEvent(self.time, self.ticker, -10, 100, 0))
        self.assertEqual(position.direction, 1)
        position.transact_fill_event(FillEvent(self.time, self.ticker, -10, 100, 0))
        self.assertEqual(position.direction, 1)
        ...
        with self.assertRaises(AssertionError):
            position.transact_fill_event(FillEvent(self.time, self.ticker, -21, 100, 0))
    ...
    def test_closed_position(self):
        ...
        with self.assertRaises(AssertionError):
            position.transact_fill_event(FillEvent(self.time, self.ticker, 1, 100, 0))
    ...
    def test_realised_pnl(self):
        ...
        position = Position(self.ticker)
        position.transact_fill_event(FillEvent(self.time, self.ticker, 20, 100, 0))
        position.transact_fill_event(FillEvent(self.time, self.ticker, -10, 80, 20))
