...
class TestPosition(unittest.TestCase):
    ...
    def test_initial_fill_position(self):
        position = BacktestPosition(self.contract)
        position.transact_transaction(Transaction(self.time, self.contract, 50, 100, 5))
    ...
    def test_without_commission_position(self):
        ...
        position.transact_transaction(Transaction(self.time, self.contract, 50, 100, 0))
        position.transact_transaction(Transaction(self.time, self.contract, 30, 120, 0))
        position.transact_transaction(Transaction(self.time, self.contract, -20, 175, 0))
        position.transact_transaction(Transaction(self.time, self.contract, -30, 160, 0))
        position.transact_transaction(Transaction(self.time, self.contract, 10, 150, 0))
        position.transact_transaction(Transaction(self.time, self.contract, 10, 170, 0))
        position.transact_transaction(Transaction(self.time, self.contract, -20, 150, 0))
        position.update_price(110, 120)
    ...
    def test_position(self):
        ...
        position.transact_transaction(Transaction(self.time, self.contract, 50, 100, 5))
        position.transact_transaction(Transaction(self.time, self.contract, 30, 120, 3))
        position.transact_transaction(Transaction(self.time, self.contract, -20, 175, 2))
        position.transact_transaction(Transaction(self.time, self.contract, -30, 160, 1))
        position.transact_transaction(Transaction(self.time, self.contract, 10, 150, 7))
        position.transact_transaction(Transaction(self.time, self.contract, 10, 170, 4))
        position.transact_transaction(Transaction(self.time, self.contract, -20, 150, 5))
        position.update_price(110, 120)
    ...
    def test_realised_pnl(self):
        ...
        position = BacktestPosition(self.contract)
        position.transact_transaction(Transaction(self.time, self.contract, 20, 100, 0))
        position.transact_transaction(Transaction(self.time, self.contract, -10, 80, 20))
